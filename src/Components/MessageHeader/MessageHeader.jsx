  ...
  return (
    <div className="message-header-container">
      <div className="message-header-container__left">
        <Link className="message-header-container__icon-link" to={"/"}>
          <TbArrowBackUp />
        </Link>
        <img
          ...
          alt={author}
        />
        <h2 className="message-header-container__Channel_name">
          {author || "Sin autor"}
        </h2>
      </div>
      <div className="message-header-container__right">
        <button className="message-header-container__icon">
          <BsCameraVideo />
        </button>
        <button className="message-header-container__icon">
